        ...
        while True:
            ...
            while True:
                ...
                if x == ALLOC_SIZE_1:  # Wenn das Ende des Speicherbereichs erreicht ist, Schleife beenden
                    ...
                    semaphore.acquire()
                    mem_alloc_2[:8] = total_byte  # Gesamtsumme in den 2. Shared Memory Bereich schreiben (1-8 Bytes)
                    mem_alloc_2[8:16] = avg_byte  # Durchschnitt in den 2. Shared Memory Bereich schreiben (9-16 Bytes)
                    semaphore.release()
                    break
